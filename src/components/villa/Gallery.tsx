...
export const Gallery = () => {
  const ref = useReveal();
  return (
    <section id="gallery" ref={ref} className="relative py-28 md:py-40 bg-cream overflow-hidden">
      <div className="container mx-auto px-6 lg:px-16">
        ...
        <div className="grid grid-cols-12 gap-3 md:gap-5">
          ...
          <figure data-reveal data-delay="100" className="reveal img-cinematic col-span-6 md:col-span-5 aspect-[4/5]">
          ...
          <figure data-reveal data-delay="300" className="reveal img-cinematic col-span-12 md:col-span-5 aspect-[4/3]">
          ...
          <figure data-reveal data-delay="400" className="reveal img-cinematic col-span-12 md:col-span-4 aspect-[4/5]">
          ...
          <figure data-reveal data-delay="200" className="reveal img-cinematic col-span-12 md:col-span-4 aspect-[4/5]">
