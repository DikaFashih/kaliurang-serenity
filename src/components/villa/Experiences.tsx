...
export const Experiences = () => {
  const ref = useReveal();
  return (
    <section id="experiences" ref={ref} className="relative fluid-section-y bg-forest-deep text-cream overflow-hidden">
      {/* Atmospheric texture */}
      ...
      <div className="relative container mx-auto fluid-gutter-x">
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          <h2 data-reveal className="reveal font-display fluid-display-lg text-balance">
            Six ways to <em className="italic font-light text-terracotta-soft">disappear</em> into the mountain.
          </h2>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-6 md:gap-x-8 gap-y-12 md:gap-y-20">
          {experiences.map((exp, i) => (
            ...
            >
              <div className="img-cinematic aspect-[4/5] mb-5 md:mb-6 overflow-hidden">
                <img
                  src={exp.img}
                  alt={exp.title}
                  loading="lazy"
              ...
              <h3 className="font-display fluid-h3 mb-2 md:mb-3 group-hover:text-terracotta-soft transition-colors duration-700">
                {exp.title}
              </h3>
